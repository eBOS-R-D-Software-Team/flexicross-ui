...
// Helper to generate a random coordinate near a base value
const randomCoordinate = (base: number, variation: number = 0.001): number =>
  base + (Math.random() - 0.5) * variation;

// Dynamic generator for dummy risk data
 const generateDummyData = (count: number): dataItem[] => {
  ...
  for (let i = 0; i < count; i++) {
    ...
    const baseLon = 23.7835;
    const baseLat = 37.9784;
      ...
      involvedObjects: [
        {
          ...
          location: {
            ...
            geometry: {
              type: "Point",
              coordinates: [randomCoordinate(baseLon), randomCoordinate(baseLat)],
            },
            properties: {
        ...
        // You can add more involvedObjects here if needed...
      ],
      location: {
        type: "Feature",
        geometry: {
        ...
        geometries: [
          {
            ...
            geometry: {
              ...
              coordinates: [
                [
                  [randomCoordinate(baseLon), randomCoordinate(baseLat)],
                  [randomCoordinate(baseLon), randomCoordinate(baseLat)],
                  [randomCoordinate(baseLon), randomCoordinate(baseLat)],
                ],
              ],
